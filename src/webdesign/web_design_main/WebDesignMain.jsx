...
import AdditionalInfoCard from "../../sharedComponents/AdditionalInfo.jsx"
  ...
  return (
    <div className="main__container">
      <div className="additionalInfo additionalInfo__web">
        ...
        <AdditionalInfoCard
          src={transferImg}
          alt="transfer international website design"
          className="transfer"
          title="Transfer"
        ...
        <AdditionalInfoCard
          src={photonImg}
          alt="photon international website design"
          className="photon"
          title="Photon"
        ...
        <AdditionalInfoCard
          src={builderImg}
          alt="builder international website design"
          className="builder"
          title="Builder"
        ...
        <AdditionalInfoCard
          src={blogrImg}
          alt="blogr international website design"
          className="blogr"
          title="Blogr"
        ...
        <AdditionalInfoCard
          src={campImg}
          alt="Camp international website design"
          className="camp"
          title="Camp"
